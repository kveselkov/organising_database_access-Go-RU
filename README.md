...
Что бы код выглядил красивым и DRY (Don't Repeat Yourself - рус. не повторяйся), вы иногда можете использовать функцию инициализации, которая будет устанавливать глобальный пул соединений из других пакетов и тестов. 
...
Лично я не фанат переменных уровня приложения в контексте в области видимости запроса - он выглядит неуклюжим и обременительным для меня. Документация пакета x/net/context так же советует:
